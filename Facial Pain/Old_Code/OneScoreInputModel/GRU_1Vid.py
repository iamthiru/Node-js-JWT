...
Original file is located at
    https://colab.research.google.com/drive/1kmZBJmReIc8BWBBM2d8DOu8OJi7hQGI2
"""
...
class PainDataset_Train(Dataset):
    ...
    def __init__(self):
        with open('/content/drive/MyDrive/One_score_input_model/Data/Files/111914_w_63.csv', 'r') as f:
        # with open('/content/drive/MyDrive/MultiPain/GRU/Data/071709_w_23.csv', 'r') as f:
          xy_pain = np.loadtxt(f, delimiter=",",dtype=np.float32,skiprows=1)
