...
def Retrieve_AUs(opath, fpath, D):
    ...
    df2 = pd.read_csv(fpath, usecols=['frame',
                                      ' AU04_r', ' AU06_r', ' AU07_r', ' AU09_r',
                                      ' AU10_r', ' AU15_r', ' AU25_r', ' AU45_r', ' AU20_r', ' AU25_r', ' AU26_r',
...
if __name__ == "__main__":
    ...
    if ch == 1:
        ...
        if tag == 1:
            in_path = "/Users/pranavdeo/Desktop/" + filenm
        else:
            in_path = "/Users/pranavdeo/PycharmProjects/FaceEmotionRecognition/Face_Input_Videos/face.png"
        os.chdir('OpenFace')
