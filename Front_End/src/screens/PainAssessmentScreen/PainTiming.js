...
const PainTiming = ({ gotoNext, gotoPrevious }) => {
    ...
    return (
        <>
            <ScrollView>
                <Text style={{ width: width, textAlign: 'left', paddingLeft: 30, fontSize: 12, lineHeight: 16, color: COLORS.GRAY_80, marginTop: 11, marginBottom: 6 }}>
                ...
                <View style={{ width: width, borderTopWidth: 1, borderBottomWidth: 1, borderColor: COLORS.PRIMARY_MAIN, backgroundColor: COLORS.WHITE, paddingHorizontal: 30, paddingTop: 27, paddingBottom: 67, marginBottom: 38 }}>
                    ...
                    <CustomTouchableOpacity onPressIn={() => { setShowDatePicker(true) }} style={{ marginBottom: 10 }}>
                        <View style={{ flexDirection: "row", width: ((width / 2) - 30), height: 36, borderRadius: 5, backgroundColor: COLORS.WHITE, borderColor: COLORS.GRAY_80, borderWidth: 1, minWidth: 100, paddingVertical: 6, paddingLeft: 16, paddingRight: 7.5, alignItems: "center", justifyContent: "space-between" }}>
