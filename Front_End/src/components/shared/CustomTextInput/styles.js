...
const styles = StyleSheet.create({
    ...
    txtInput: { height: 55, borderRadius: 5, backgroundColor: COLORS.WHITE, borderColor: COLORS.GRAY_80, borderWidth: 1, minWidth: 100, paddingLeft: 16, color: COLORS.GRAY_90, fontSize: 16 }
});
