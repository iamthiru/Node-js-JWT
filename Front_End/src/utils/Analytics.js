...
class Analytics {
  ...
  static setPatientInfo = async (
    ...
    await firebaseAPI.setPatientInfo(
      id,
      name,
      dob,
      age,
  ...
  static setAssessmentData = async (
    id,
    patientId,
    date,
    impactScore,
    ...
    await firebaseAPI.setAssessmentData(
      id,
      patientId,
      date,
      impactScore,
  ...
  static removeData = async (data) => {
    await firebaseAPI.removeData(data);
  };
  static update = async (id, name, dob, age, medicalRecordNumber, gender) => {
